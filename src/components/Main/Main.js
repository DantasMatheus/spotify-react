    ...
    return(
        ...
        <div id="result-playlists">
            <div className="playlist">
                ...
                <h2 className="greeting-subtitle">Ouça as músicas que você mais gosta</h2>
            </div>
                ...
                <div className="artist-card" id="">
                    ...
                    <div className="card-text">
                        <a title="Foo Fighters" className="vst" href="">
                            <span className="artist-name" id="artist-name">Foo Fighters</span>
